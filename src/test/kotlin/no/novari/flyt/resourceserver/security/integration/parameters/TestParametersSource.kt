...
import no.novari.flyt.resourceserver.security.integration.parameters.TestParametersCategory.ACTUATOR
import no.novari.flyt.resourceserver.security.integration.parameters.TestParametersCategory.EXTERNAL_CLIENT_API_IF_DISABLED
import no.novari.flyt.resourceserver.security.integration.parameters.TestParametersCategory.EXTERNAL_CLIENT_API_IF_ENABLED
import no.novari.flyt.resourceserver.security.integration.parameters.TestParametersCategory.GLOBAL
import no.novari.flyt.resourceserver.security.integration.parameters.TestParametersCategory.INTERNAL_ADMIN_API_IF_INTERNAL_API_ENABLED
import no.novari.flyt.resourceserver.security.integration.parameters.TestParametersCategory.INTERNAL_CLIENT_API_IF_DISABLED
import no.novari.flyt.resourceserver.security.integration.parameters.TestParametersCategory.INTERNAL_CLIENT_API_IF_ENABLED
import no.novari.flyt.resourceserver.security.integration.parameters.TestParametersCategory.INTERNAL_USER_API_IF_INTERNAL_API_DISABLED
import no.novari.flyt.resourceserver.security.integration.parameters.TestParametersCategory.INTERNAL_USER_API_IF_INTERNAL_API_ENABLED
